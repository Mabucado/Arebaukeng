...
class DisplayAppointments : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = DisplayAppointmentsAdapter(model.appointmentTable.map { appointment ->AppointmentList(appointment.name,appointment.nurse,appointment.time)})
